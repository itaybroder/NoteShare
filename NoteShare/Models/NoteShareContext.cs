...
namespace NoteShare.Models
{
    public partial class NoteShareContext : DbContext
    {
        ...
        public virtual DbSet<SharedNotebookTbl> SharedNotebookTbl { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-KFPSAOP;Database=NoteShare;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SharedNotebookTbl>(entity =>
            {
                entity.HasKey(e => new { e.UserId, e.NotebookId });

                entity.ToTable("SharedNotebookTBL");
                ...
                entity.HasOne(d => d.User)
                    .WithMany(p => p.SharedNotebookTbl)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_SharedNotebookTBL_UserTBL");
            });
